...
def google_callback(request):
    ...
    #print(params)
    frontend_google_login = os.environ.get('frontend_google_login') #'http://localhost:3000/google/' #
...
def facebook_callback(request):
    params = urlencode(request.GET)
    #print(params)
    frontend_facebook_login = os.environ.get('frontend_facebook_login') #'http://localhost:3000/facebook/' #
