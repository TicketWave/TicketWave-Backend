...
class Event(models.Model):
    ...
    )  # "2004-03-15 12:01" format value example
    ...
    recurring_start_day = models.CharField(
        max_length=16, default="saturday", choices=day_choices
    )
    recurring_end_day = models.CharField(
        max_length=16, default="saturday", choices=day_choices
    )
    recurring_start_month = models.CharField(
        max_length=16, default="january", choices=month_choices
    )
    recurring_end_month = models.CharField(
        max_length=16, default="january", choices=month_choices
    )
    ...
    recurring_frequency = models.CharField(
        max_length=16, default="monthly", choices=rec_choices
    )
    ...
    followers = models.ManyToManyField(
        Users, related_name="following_event", blank=True
    )
