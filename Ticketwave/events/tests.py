...
class EventTestCase(TestCase):
    def setUp(self):
        ...
        self.view_counter_expected_data = {"id": 1, "view_counter": 0}
    ...
    def test_event_follow(self):
        event1 = Event.objects.get(name="Test Event")
        followtestuser = Users.objects.create(
            username="followtestuser",
            email="followtestuser@beatles.com",
            password="gasyhdias",
        )
    ...
    def test_event_unfollow(self):
        ...
        followtestuser = Users.objects.create(
            ...
            email="followtestuse22r@beatles.com",
            password="ga2syhdias",
        )
        event1.followers.add(followtestuser)
        follower_count = event1.followers.count()
