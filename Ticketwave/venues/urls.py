...
from .views import venue_Create, venue_Destroy, venue_List, venue_Update, venue_Retrieve, venue_get_user_location
...
urlpatterns = [
    ...
    path('user_location/', venue_get_user_location.as_view()),
]
